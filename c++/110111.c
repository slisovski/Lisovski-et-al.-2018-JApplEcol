              ...
              double *yout, int *ip)
{
    ...
    ydot[6] = -beta_m*(y[1] + y[4] + y[7])*y[6]                 + sigma*y[8] - h*y[6]  - mort*y[6]                           + M*(Pr_M*pop*((y[0]/(y[0]+y[1]+y[2]))+((y[2]/(y[0]+y[1]+y[2]))*b))) + T*y[8];
    ydot[7] =  beta_m*(y[1] + y[4] + y[7])*y[6]   - gamma*y[7]               + h*y[6]  - mort*y[7]				    + M*(Pr_M*pop*(y[1]/(y[0]+y[1]+y[2])));
    ydot[8] =							        + gamma*y[7]  - sigma*y[8] 		     - mort*y[8]   + M*(Pr_M*pop*((y[2]/(y[0]+y[1]+y[2]))-((y[2]/(y[0]+y[1]+y[2]))*b))) - T*y[8];
