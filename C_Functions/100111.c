              ...
              double *yout, int *ip)
{
    ...
    ydot[3] = -beta_m*(y[1] + y[4])*y[3]                 + sigma*y[5] - h*y[3]  - mort*y[3]                          + M*Pr_M*pop + T*y[5];
    ydot[4] =  beta_m*(y[1] + y[4])*y[3]   - gamma*y[4]               + h*y[3]  - mort*y[4];
    ydot[5] =							 + gamma*y[4]  - sigma*y[5] 		  - mort*y[5]  - T*y[5];
